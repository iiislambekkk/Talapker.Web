...
export function AmbassadorSiteHeader() {
    ...
    const {data: institution, status} = useQuery({...institutionByIdOptions(session?.user.tenantId!), enabled: sessionStatus == "authenticated"})
