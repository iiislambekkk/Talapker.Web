...
export function AmbassadorNavMain({
                                      items,
                                  }: {
    items: {
    ...
    return (
        <SidebarGroup>
            <SidebarGroupLabel>Ambassador</SidebarGroupLabel>
            <SidebarMenu>
                {items.map((item) => {
                    if (!item.items) {
                        return (
                            <SidebarMenuItem key={item.localizationKey}>
                                ...
                                <CollapsibleContent>
                                    <SidebarMenuSub>
                                        {item.items?.map((subItem) => (
                                            <SidebarMenuSubItem key={subItem.localizationKey}>
