...
import { educationProgramQueryOptions } from "./_components/educationProgramQueryOptions";
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                    ...
                    <div className="flex items-center gap-2 flex-col">
                        ...
                        <DeleteEducationProgramDialog
                            ...
                            programName={program.name[lang as keyof typeof program.name] || program.name.ru}
                        />
                    </div>
                </div>
            </div>
