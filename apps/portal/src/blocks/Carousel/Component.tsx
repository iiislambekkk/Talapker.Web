...
export const CarouselBlock: React.FC<CarouselBlockProps & { className?: string }> = ({ slides }) => {
  ...
  return (
    <section className="relative w-full overflow-hidden my-12">
      <div ref={emblaRef}>
        <div className="flex">
          {slides.map((slide, i) => (
            <div className="relative flex-[0_0_100%] min-w-0" key={i}>
              <div className="w-full flex justify-center items-center overflow-hidden bg-black/5">
              ...
              {(slide.richText || (slide.links && slide.links.length > 0)) && (
                <div className="absolute inset-0 z-20 flex items-center justify-center p-6 bg-black/20">
